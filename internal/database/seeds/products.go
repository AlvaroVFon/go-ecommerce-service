...
func SeedProducts(db *sql.DB) error {
	...
	products := []products.Product{
		{Name: "Laptop", Description: &description1, Price: 1200.00, Stock: new(int32)},
		{Name: "Smartphone", Description: &description2, Price: 800.00, Stock: new(int32)},
		{Name: "Coffee Maker", Description: &description3, Price: 150.00, Stock: new(int32)},
		{Name: "Running Shoes", Description: &description4, Price: 120.00, Stock: new(int32)},
		{Name: "Novel", Description: &description5, Price: 20.00, Stock: new(int32)},
	}
